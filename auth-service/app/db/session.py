"""
Auth Service — Database session configuration.
...
DATABASE_URL: str = os.getenv(
    "AUTH_DATABASE_URL",
    "postgresql+asyncpg://smartsync:smartsync@localhost:5432/smartsync_auth",
)
...
engine = create_async_engine(
    ...
    connect_args={
        "server_settings": {
            "search_path": "auth",          # Default schema for auth service
            "application_name": "smartsync-auth-service",
        }
    },
)
