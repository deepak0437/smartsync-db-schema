"""
Notification Service — Database session configuration.
...
DATABASE_URL: str = os.getenv(
    ...
    "postgresql+asyncpg://smartsync:smartsync@localhost:5432/smartsync_notification",
)
...
engine = create_async_engine(
    ...
    connect_args={
        "server_settings": {
            "search_path": "notification",          # Default schema for notification service
            "application_name": "smartsync-notification-service",
        }
    },
)
...
async def init_db() -> None:
    ...
    async with engine.begin() as conn:
        ...
        await conn.execute(__import__("sqlalchemy").text("CREATE SCHEMA IF NOT EXISTS notification"))
