"""
Security Service — Database session configuration.
...
DATABASE_URL: str = os.getenv(
    ...
    "postgresql+asyncpg://smartsync:smartsync@localhost:5432/smartsync_security",
)
...
engine = create_async_engine(
    ...
    connect_args={
        "server_settings": {
            "search_path": "security",          # Default schema for security service
            "application_name": "smartsync-security-service",
        }
    },
)
...
async def init_db() -> None:
    ...
    async with engine.begin() as conn:
        ...
        await conn.execute(__import__("sqlalchemy").text("CREATE SCHEMA IF NOT EXISTS security"))
